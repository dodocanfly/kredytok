...
final class Version20240911180704 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , cost DOUBLE PRECISION NOT NULL, date DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , active BOOLEAN DEFAULT 1 NOT NULL, CONSTRAINT FK_C5D30D03A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
